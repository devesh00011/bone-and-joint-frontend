                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-10">
                    {servicesData.map((service, index) => (
                        ...
                        >
                            ...
                            <Link href={`/services/${service.service_slug}`}><button className="mt-4 text-md font-medium bg-[#00B4D8]  hover:bg-blue-600 text-white  px-3 py-1.5 cursor-pointer hover:rounded-3xl duration-300">
                                View Details →
                            </button></Link>
                        </div>
                    ))}
